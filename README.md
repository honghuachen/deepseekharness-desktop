...
- Switching to a version **pins** it: you can freely switch to any version in the list whenever desired, and the active version remains pinned across launches without automatic switching. `prune()` preserves the active pinned version.
